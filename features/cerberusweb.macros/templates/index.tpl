<div id="automatorSetup"></div>
<form action="{devblocks_url}{/devblocks_url}" style="margin-bottom:5px;">
	<button type="button" onclick="genericAjaxPanel('c=automator&a=showAutomatorFilterPanel&id=0',null,false,'550');"><span class="cerb-sprite sprite-funnel"></span> Add Automator Macro</button>
</form>
